...
public class Testcase {
	...
	public String toString() {
		return "Order [id=" + id + ", identification=" + identification + ", name=" + name + ", testedTarget="
				+ testedTarget + ", severity=" + severity + ", input=" + input + ", instruction=" + instruction
				+ ", expectedResult=" + expectedResult + ", testResult=" + testResult + "]";
	}
